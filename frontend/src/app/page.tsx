...
const INITIAL_TICKETS: ServiceTicket[] = [
  ...
  },
  {
    ...
    totalWithVat: 85.60,
    vehicleId: 308,
    licensePlate: 'CAP-1941',
    vehicleBrand: 'Isuzu',
    vehicleModel: 'MU-X Ultimate',
    vehicleYear: 2016,
    customerId: 408,
    customerName: 'Steve Rogers',
    customerPhone: '+1-555-0422',
    mechanicId: null,
    mechanicName: null,
    items: [],
  ...
  },
  {
    ...
    totalWithVat: 107.00,
    vehicleId: 310,
    licensePlate: 'GREEN-8',
    vehicleBrand: 'Isuzu',
    vehicleModel: 'Elf',
    vehicleYear: 2023,
    customerId: 409,
    customerName: 'Bruce Banner',
    customerPhone: '+1-555-0533',
    mechanicId: null,
    mechanicName: null,
    items: [],
  ...
  },
  {
    ...
    totalWithVat: 53.50,
    vehicleId: 311,
    licensePlate: 'BLACK-W',
    vehicleBrand: 'Isuzu',
    vehicleModel: 'Rodeo',
    vehicleYear: 2021,
    customerId: 410,
    customerName: 'Natasha Romanoff',
    customerPhone: '+1-555-0644',
    mechanicId: null,
    mechanicName: null,
    items: [],
  ...
  },
  {
    ...
    totalWithVat: 74.90,
    vehicleId: 320,
    licensePlate: 'STARK-5',
    vehicleBrand: 'Isuzu',
    vehicleModel: 'D-Max Cab4',
    vehicleYear: 2021,
    customerId: 408,
    customerName: 'Steve Rogers',
    customerPhone: '+1-555-0422',
  ...
  },
  {
    ...
    mechanicName: null,
    items: [],
    createdAt: '2026-05-30T11:25:00Z',
    updatedAt: '2026-05-30T11:25:00Z',
  },
  {
    id: 1012,
    ...
    totalWithVat: 48.15,
    vehicleId: 322,
    licensePlate: 'SPY-007',
    vehicleBrand: 'Isuzu',
    vehicleModel: 'Trooper SE',
    vehicleYear: 2022,
    customerId: 410,
    customerName: 'Natasha Romanoff',
    customerPhone: '+1-555-0644',
  ...
  },
  {
    ...
    customerPhone: '+1-555-0866',
    mechanicId: null,
    mechanicName: null,
    items: [],
    createdAt: '2026-05-30T11:35:00Z',
    updatedAt: '2026-05-30T11:35:00Z',
  }
];
